<template>
  <aside class="app-sidebar">
    ...
    <nav class="sidebar-menu">
      ...
      <button class="sidebar-menu__item">Товары</button>
      <button class="sidebar-menu__item">Маркетинг</button>
      <button class="sidebar-menu__item">Финансы</button>
      <button class="sidebar-menu__item">Настройки</button>
    </nav>
